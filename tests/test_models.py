...
def test_ACT_models():
    ...
    result = (
            ...
            tSZ_and_CIB_Choi2020(
                ...
                {'ell':ells, 'ell_0': par['ell_0'], 
                 'amp': par['a_tSZ']},
                {'ell':ells, 'ell_0': par['ell_0'], 'amp': par['a_c']},
                {'ell':ells, 'ell_0': par['ell_0'], 
                 'amp': - par['xi'] * np.sqrt(par['a_tSZ'] * par['a_c'])}
                )}),

            par['a_c'] * cibc_Choi2020(
            	{"nu": fdust, "nu_0": par['nu_0'],
            	"temp": par['T_d'], "beta": par["beta_c"]},
            	{'ell':ells, 'ell_0':par['ell_0']})
    ...
    choi20 = np.array([
    	-0.6126904183896509, # cibxtsz_Choi2020 
        4.286610513310932, #cibc_Choi2020
        ])
    ...
    tsz_fg, ksz_fg, cibp_fg, cibc_fg, cibxtxz_fg, sync_fg, cirrus_fg, cibxtxz_Choi2020, cibc_Choi2020 = result
    ...
    assert ( np.abs(cibc_Choi2020-choi20[1]) / choi20[1] < 1e-3 )
    assert ( np.abs(cibxtxz_Choi2020-choi20[0]) / choi20[0] < 1e-3 )
